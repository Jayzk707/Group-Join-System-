<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"template/substation/index/index.html";i:1698823782;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="login-wrapper">
            ...
            <div class="form-wrapper">
                ...
                <div class="btn" onclick="location='fufei.wtyz.cn/fenxiao.php'"  >代理后台登录</div>
            </div>
        </div>
    </div>
    <script>
